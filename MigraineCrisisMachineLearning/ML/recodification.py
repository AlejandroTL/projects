...
wb = openpyxl.load_workbook('Gotit.xlsx', data_only=True)
...
print("MEDIA HUMOR")
humor = SAX_complete.SAX_recodificated(7, 'humor', 3)

print("MEDIA APETITO")
apetito = SAX_complete.SAX_recodificated(4, 'apetito', 3)

print("MEDIA SUENO")
sueno = SAX_complete.SAX_recodificated(2, 'sueno', 2)

print("MEDIA COGNITIVOS")
cognitivos = SAX_complete.SAX_recodificated(3, 'cognitivos', 3)

print("MEDIA TERMICOS")
termicos = SAX_complete.SAX_recodificated(2, 'termicos', 2)

print("MEDIA OTROS")
otros = SAX_complete.SAX_recodificated(12, 'otros', 3)

print("MEDIA GASTROINTESTINALES")
gastrointestinales = SAX_complete.SAX_recodificated(5, 'gastrointestinales', 3)
