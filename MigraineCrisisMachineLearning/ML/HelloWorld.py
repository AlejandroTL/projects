...
wb = openpyxl.load_workbook('Datos_parseados.xlsx', data_only=True)
...
print("MEDIA HUMOR")
humor = SAX_complete.SAX_global(7, 'humor', 3)

print("MEDIA APETITO")
apetito = SAX_complete.SAX_global(4, 'apetito', 3)

print("MEDIA SUENO")
sueno = SAX_complete.SAX_global(2, 'sueno', 2)

print("MEDIA COGNITIVOS")
cognitivos = SAX_complete.SAX_global(3, 'cognitivos', 3)

print("MEDIA TERMICOS")
termicos = SAX_complete.SAX_global(2, 'termicos', 2)

print("MEDIA OTROS")
otros = SAX_complete.SAX_global(12, 'otros', 3)

print("MEDIA GASTROINTESTINALES")
gastrointestinales = SAX_complete.SAX_global(5, 'gastrointestinales', 3)
